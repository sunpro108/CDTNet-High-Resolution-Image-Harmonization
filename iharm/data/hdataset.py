...
class HDataset(BaseHDataset):
    ...
    def get_sample(self, index):
        ...
        '''    
        composite_image_name = self.dataset_samples[index]
        real_image_name = '_'.join(composite_image_name.split('_')[:-2]) + '.jpg'
        mask_name = '_'.join(composite_image_name.split('_')[:-1]) + '.png'
        composite_image_name = '_'.join(composite_image_name.split('_')[:-1]) + "/" + composite_image_name
        '''
